...
function crearClasePersona() {
  class Persona {
    ...
    getFriends() {
      ...
      // Tu código aca:
      let respuesta = this.amigos.map(objec => {
      return objec.nombre;
      })
      return respuesta;
    } 
    ...
    getHobbies() {
      ...
      // Tu código aca:
      let respuesta = this.hobbies.map(element => {
        return element;
      });
      return respuesta;
    }
    ...
    getPromedioEdad() {
      ...
      // Tu código aca:
      const resultado = this.amigos.reduce(function (total, amigos){
        return (total + amigos.edad);
      }, 0);
      return resultado / 2;
    } 
  };
